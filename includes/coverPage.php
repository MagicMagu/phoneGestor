...
<body>
  <main class="slide">
    ...
    <div id="sl-2" class="slide-item">
      <h2>Máxima seguridad</h2>
      <p>El gestor de números de telefono más seguro del múndo, con cifrado hecho por nuestros expertos en seguridad informatica capas de evitar cualquier tipo de robo de cuentas, o urto de tus número de telefono</p>
    </div>
    <div id="sl-3" class="slide-item">
