<?php 
  class log_InModel{
    ...
    public function verifyUser($user, $password){
      ...
      if ($userData = $this->database->query("SELECT * FROM users WHERE user='$user'")) {
