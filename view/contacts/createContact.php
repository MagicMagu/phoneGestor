  ...
  <div class="contenedor">
    ...
    <form class="flex-columna" method="POST">
      ...
      <div class="flex">
        ...
        <input type="tel" name="phone" class="inputs" max="12" maxlength="12" placeholder="Número de telefono" required="true">
      </div>
      <button type="submit" class="btn btn-load" name="newcontact">Crear</button>
    </form>
  </div>
</body>
</html>